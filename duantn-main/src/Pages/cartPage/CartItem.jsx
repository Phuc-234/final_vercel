...
import { CartLoading, CartSuccess } from "../../Redux/Cart/cart.types";
...
const CartItem = ({
  ...
  //   const userCarts = Object.values(cartData).flat();
    
  //   // Tính tổng số lượng sản phẩm
  //   return userCarts.reduce((total, item) => total + (item.quantity || 0), 0);
  // };
          ...
          >
            ...
            >
              ...
              >
                <Button
                  onClick={() => {
                    handleDec(); // Gọi hàm handleDec
                    window.location.reload(); // Reload lại trang sau khi xử lý
                  }}
                  size="xs"
                  color="gray"
                >
